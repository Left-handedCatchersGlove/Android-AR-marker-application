...
//		mRenderer.setMainHandler(mHandler);
	...
	private void initializeGLSurfaceView() {
    	...
    	if (arToolkitDrawer == null) {
			...
			patt.add(getResources().openRawResource(R.raw.pattz));
			//patt.add(getResources().openRawResource(R.raw.pattface));
...
//----------------------- for min3d ------------------------
	...
	public void initScene()
	{
		...
		// オブジェクト1
		//parser = Parser.createParser(Parser.Type.MD2, getResources(), "jp.androidgroup.nyartoolkit:raw/droid", false);
		//parser = Parser.createParser(Parser.Type.MD2, getResources(), "jp.androidgroup.nyartoolkit:raw/pool", false);
		parser = Parser.createParser(Parser.Type.MD2, getResources(), "jp.androidgroup.nyartoolkit:raw/arrow", false);
		parser.parse();
